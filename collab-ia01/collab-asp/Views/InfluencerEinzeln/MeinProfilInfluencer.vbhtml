...
<head>
    ...
    <title>MeinProfilInfluencer</title>
</head>
<body>
    <!-- Header -->
    <div>
            ...
            <div id="primaryContentBlock" class="parallax">
                <div id="meinProfilBild">
                    ...
                    <div class="buttonHalterMP">
                        <input class="button" type="button" onclick="location.href='http://localhost:50935/Html/MeineJobanzeigen.html';" value="Meine Bewerbungen" />
