                    ...
                    <div class="jumbotron">
                        <div class="text-center">
                            <h1 class="align-content-lg-end mb-lg-3">
                                ...
                                @Html.DisplayFor(Function(m) m.Unternehmen.Firmenname)
                            </h1>
                            <h2 class="align-content-end mb-lg-3">
                                [at]
                                @Html.DisplayFor(Function(m) m.Unternehmen.Benutzername)
                            </h2>
                            <h3 class="align-content-end mb-lg-5">
                                <!-- Hier Bewertung in Form von Sternchen -->
                                Bewertung:
                            </h3>
                        </div>
                    </div>
                ...
                <div class="mt-lg-2">
                    <div>
                        ...
                        <p class="text-center mb-lg-5">
                            @Html.DisplayFor(Function(m) m.Unternehmen.Branche.BrancheTitel)
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-center mb-lg-5">
                            @Html.DisplayFor(Function(m) m.Unternehmen.Beschreibung)
                            adfadfadf
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-center mb-lg-5">
                            @Html.DisplayFor(Function(m) m.Unternehmen.Email)
                        </p>
                    </div>
                </div>
            </div>
